    ...
    <div className="mx-auto max-w-[1500px] px-5 py-8 md:px-10 md:py-10 space-y-8">
      ...
      {form.modalAbierto && (
        <dialog
          open
          onClick={(e) => {
            if (e.target === e.currentTarget) dispatch({ type: 'CERRAR_MODAL' })
          }}
        ...
        >
          <div
            ...
            className="w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900 p-7 text-slate-100 shadow-2xl animate-in fade-in zoom-in-95 duration-200"
          >
